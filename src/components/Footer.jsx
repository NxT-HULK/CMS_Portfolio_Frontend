...
const Footer = () => {
    ...
    const { socialLinks, noNav } = useContext(DataContext)
    const { removeSlash, handleOnChange, handleSubmitSubscriptionForm } = useContext(FunctionContext)
    ...
    return (
        <>
            {noNav.indexOf(removeSlash(router?.pathname)) >= 0 &&
                <div className={`bg-dark w-100 user-select-none`}>
                    <div className="container pb-3 pt-5">
                        <div className='d-flex flex-wrap justify-content-md-between justify-content-center gap-md-0 gap-5'>
                            ...
                            <div className='d-flex flex-column gap-2 d-flex flex-column align-items-md-end col-md-4 col-12'>
                                ...
                                <div>
                                    <form className={`d-flex align-items-center justify-content-center flex-column`} onSubmit={(e, data) => { handleSubmitSubscriptionForm(e, data) }}>
