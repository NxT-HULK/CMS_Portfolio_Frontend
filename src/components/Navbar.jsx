...
const Navbar = () => {
    ...
    const { darkTheamFlag } = useContext(FunctionContext)
    ...
    return (
        <>
            <nav className={`navbar navbar-expand-lg mainNav ${darkTheamFlag === true ? 'position-fixed' : 'position-sticky'} top-0 w-100 z-3`}>
